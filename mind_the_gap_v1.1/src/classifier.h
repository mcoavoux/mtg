...
public:
    ...
    enum {PERCEPTRON, FAST_PER, FASTER_PER, FASTEST_PER, FFNN, RNN, CHAR_RNN};
...
public:
    Rnn(int n_classes, const string &outdir);

    Rnn(int n_classes);

    Rnn(int n_classes, FeatureExtractor *fe, NeuralNetParameters &params);
    ~Rnn();
