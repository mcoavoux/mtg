...
public:
    ...
    enum {DISCBRACKET, TBK}; // treebank format
    ...
    void write_conll(const string& filename, vector<vector<std::pair<String, String> > > &str_sentences);
    ...
    static int find_closing_bracket(int i, const vector<String> &sentence);
...
public:
    ...
    static bool get_xml_label(const String &s, String &label); // return true if is head
    static bool is_head(String &s);
