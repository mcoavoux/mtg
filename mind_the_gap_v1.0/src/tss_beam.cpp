...
Action::Action(int type, int code) : Action(type, 0,-1){}
...
ostream& operator<< (ostream &os, const Action &action){
    switch (action.type_){
        ...
        case Action::REDUCE_L: return os << "rl(" << action.label_ << "=" << enc::hodor.decode(action.label_,enc::CAT) << ")" << action.code_;
        case Action::REDUCE_R: return os << "rr(" << action.label_ << "=" << enc::hodor.decode(action.label_,enc::CAT) << ")" << action.code_;
        case Action::REDUCE_U: return os << "ru(" << action.label_ << "=" << enc::hodor.decode(action.label_,enc::CAT) << ")" << action.code_;
        ...
        case Action::LABEL : return os << "Label("<< action.label_ << "=" << enc::hodor.decode(action.label_,enc::CAT) << ")" << action.code_;
